...
define( 'YOURLS_DB_USER', 'if0_36728970' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'BfEScU7gRXB' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'if0_36728970_db_clicker' );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', e.g. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', 'sql112.infinityfree.com' );
...
define( 'YOURLS_SITE', 'https://invitations-mt.great-site.net' );
...
define( 'YOURLS_COOKIEKEY', '$[78r&&DG730~dvTCg[rbrObM-~7zbC%acf78N|j' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = [
	'SMKAdmin' => 'phpass:!2y!10!xe2gJgvQMnPibk1Un54VKuvWBX6MCJUPcGtDege6tgIKHTv3vZenm' /* Password encrypted by YOURLS */  /* Password encrypted by YOURLS */  /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2'
	// 'username3' => 'password3'
